...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Cybersecurity Engineer🔒 having an experience of Red Teaming and Blue Teaming in the Cybersecurity space with tools like BurpSuite, Metasploit, NMap, Splunk. My goal is to protect every individuals in the cyber space 🚀 "
  ),
  resumeLink:
